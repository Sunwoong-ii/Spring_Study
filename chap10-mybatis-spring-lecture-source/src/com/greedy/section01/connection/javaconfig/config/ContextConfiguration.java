...
public class ContextConfiguration {
	...
	// commons-pool이 의존관계에 있기 떄문에 다시한번 추가
...
//      dataSource.setDefaultAutoCommit(false);   // 수동 커밋 
	...
	public SqlSessionFactory sqlSessionFactory(ApplicationContext context) throws Exception {
		...
		// mybatis설정값 추가
		// 패키지에 대한 내용은 자바파일 .을 사용하고 xml같은 파일을 가져올 땐 폴더 형식으로/를 사용한다.
		factoryBean.setConfigLocation(
				context.getResource("com/greedy/section01/connection/javaconfig/config/mybatis-config.xml"));
